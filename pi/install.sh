...
cp /opt/kanp/pi/kanp-heal.service /etc/systemd/system/
cp /opt/kanp/pi/kanp-heal.timer /etc/systemd/system/
...
systemctl enable --now kanp-collector.service kanp-api.service kanp-export.timer kanp-heal.timer
