...
|---|---|
| `kanp-collector` | polls airplanes.live every second, writes `/var/lib/kanp/kanp.db` |
...
| `KANP_POLL_SECONDS` | `1` | airplanes.live allows 1 req/s, so 1 is the floor. Raise to 15 to be polite to the public feeds |
