  ...
  [
    ...
    [
      ...
      n('Weather Products', 'wx', 'Reports you decode and forecasts you trust.',
        [
          n('METAR', 'wx', 'Hourly observation in coded form: wind, visibility, weather, sky, temp/dewpoint, altimeter. The now.'),
    ...
    [
      ...
      n('Aeromedical Factors', 'hf', 'How altitude and stress act on the body.',
        [
          ...
          n('Spatial Disorientation', 'hf', 'The inner ear lies without outside references — the vestibular and visual systems disagree and the pilot loses the horizon.',
            [
            ...
            ], [['xGyroRef','why you trust the gyros']]),
