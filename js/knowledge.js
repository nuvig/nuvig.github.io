    ...
    [
      ...
      n('Moisture & Stability', 'wx', 'Water and vertical motion — the two ingredients that set the sky\'s whole mood.',
        [
          ...
          n('Clouds', 'wx', 'Grouped by height and form — low (stratus/stratocumulus), middle (alto-), high (cirro-, ice), and the vertical cumulus family. "Cumulus" = rising, "nimbus" = rain, "towering" = trouble building.'),
          n('Precipitation', 'wx', 'Rain, drizzle, snow, ice pellets and hail. Freezing rain means warmer air aloft over a subfreezing layer — a serious icing signature; hail marks a strong updraft even miles from the cell.', [], [['xIcingRef','freezing rain → ice']]),
        ]),
      ...
      n('Wind & Circulation', 'wx', 'Why the air moves — from the planetary scale down to the ridgeline outside the window.',
        [
          ...
          n('Local Winds', 'wx', 'Sea/land breezes reverse day to night; valley and mountain (katabatic) winds drain and climb slopes — local effects that override the gradient near the surface.'),
      ...
      n('Hazards', 'wx', 'The weather that actually bends or breaks airplanes.',
        [
          (function(){ const ts = n('Thunderstorms', 'wx', 'The complete package: severe turbulence, hail, lightning, downdrafts, low-level wind shear and microbursts. Never fly under one, and give them 20 NM.',
            ...
            ], [['xShearRef','make wind shear'],['xManeuverRef','slow to Va inside']]); return ts; })(),
      ...
      n('Weather Products & Briefing', 'wx', 'How you turn the atmosphere into a go/no-go — the reports you decode and the forecasts you weigh.',
        [
          ...
          n('METAR', 'wx', 'The hourly (or special) observation, decoded field by field: wind, visibility, present weather, sky condition, temperature/dewpoint and altimeter — the ground truth right now.'),
          n('TAF', 'wx', 'A ~5 SM airport forecast valid 24–30 hr, built from FM (rapid change), TEMPO (temporary) and BECMG (gradual) groups. It is a forecast, not a promise.'),
          ...
          n('Graphical Forecasts (GFA)', 'wx', 'The Graphical Forecast for Aviation, prog charts, and radar/satellite imagery — the big-picture map that puts the coded reports in context.'),
          n('PIREPs', 'wx', 'Pilot reports are the only in-situ truth — cloud tops, ride, icing, the actual bases. Give them as freely as you use them.'),
          n('AIRMET, SIGMET & Convective SIGMET', 'wx', 'In-flight advisories: AIRMETs for widespread moderate hazards (ice, turbulence, IFR), SIGMETs for severe, and Convective SIGMETs for lines and areas of thunderstorms.'),
        ]),
    ]),
